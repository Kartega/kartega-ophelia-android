...
public class BallPulse extends BasePreloader {
    ...
    public BallPulse(View target, int size, int duration) {
    ...
    protected List<ValueAnimator> setupAnimation() {
        ...
        valueAnimator1.setDuration(getEa_duration() == 0 ? 500 : getEa_duration());
        ...
        valueAnimator2.setStartDelay(getEa_duration() == 0 ? 250 : getEa_duration() / 2);
        valueAnimator2.setDuration(getEa_duration() == 0 ? 500 : getEa_duration());
        ...
        valueAnimator3.setStartDelay(getEa_duration() == 0 ? 500 : getEa_duration());
        valueAnimator3.setDuration(getEa_duration() == 0 ? 500 : getEa_duration());
    ...
    public int getHeight() {
        ...
        switch (getSize()) {
            case CrystalPreloader.Size.VERY_SMALL:
                height = getTarget().getResources().getDimension(R.dimen.height_ball_pulse_vs);
                break;
            case CrystalPreloader.Size.SMALL:
                height = getTarget().getResources().getDimension(R.dimen.height_ball_pulse_s);
                break;
            case CrystalPreloader.Size.MEDIUM:
                height = getTarget().getResources().getDimension(R.dimen.height_ball_pulse_m);
                break;
            case CrystalPreloader.Size.LARGE:
                height = getTarget().getResources().getDimension(R.dimen.height_ball_pulse_l);
                break;
            case CrystalPreloader.Size.EXTRA_LARGE:
                height = getTarget().getResources().getDimension(R.dimen.height_ball_pulse_el);
                break;
        }
