...
import com.ahmetkilic.ophelia.ea_progress.interpolators.EaseCubicInOutInterpolator;
...
public class Circular extends BasePreloader {
    ...
    public Circular(View target, int size, int duration) {
    ...
    protected List<ValueAnimator> setupAnimation() {
        ...
        valueAnimator1.setDuration(getEa_duration() == 0 ? 1500 : getEa_duration());
