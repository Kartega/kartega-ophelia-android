...
public class ExpandableBalls extends BasePreloader {
    ...
    public ExpandableBalls(View target, int size, int duration) {
    ...
    private void setAnimator(final int index){
        ...
        valueAnimatorMCStart.setDuration(getEa_duration() == 0 ? 700 : getEa_duration());
        ...
        valueAnimatorsStart[index].setDuration(getEa_duration() == 0 ? SPEED : getEa_duration());
        ...
        valueAnimatorsReverse[index].setDuration(getEa_duration() == 0 ? SPEED : getEa_duration());
