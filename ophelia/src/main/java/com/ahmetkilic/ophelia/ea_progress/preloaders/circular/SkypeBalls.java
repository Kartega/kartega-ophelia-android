...
public class SkypeBalls extends BasePreloader {
    ...
    public SkypeBalls(View target, int size, int duration) {
    ...
    protected List<ValueAnimator> setupAnimation() {
        int d1 = getEa_duration() == 0 ? 1500 : getEa_duration();
        int d2 = d1 / 3;
        int d3 = d1 / 5;
        int delay = d1 / 10;
        ...
        valueAnimator3.setDuration(d1);
        valueAnimator3.setStartDelay(2 * delay);
        ...
        valueAnimator4.setDuration(d1);
        valueAnimator4.setStartDelay(3 * delay);
        ...
        valueAnimator5.setDuration(d1);
        valueAnimator5.setStartDelay(4 * delay);
        ...
        radiusAnimatorStart1.setDuration(d2);
        ...
        radiusAnimatorStart2.setDuration(d2);
        radiusAnimatorStart2.setStartDelay(delay);
        ...
        radiusAnimatorStart3.setDuration(d2);
        radiusAnimatorStart3.setStartDelay(2 * delay);
        ...
        radiusAnimatorStart4.setDuration(d2);
        radiusAnimatorStart4.setStartDelay(3 * delay);
        ...
        radiusAnimatorStart5.setDuration(d2);
        radiusAnimatorStart5.setStartDelay(4 * delay);
        ...
        radiusAnimatorEnd1.setDuration(d3);
        radiusAnimatorEnd1.setStartDelay(12 * delay);
        ...
        radiusAnimatorEnd2.setDuration(d3);
        radiusAnimatorEnd2.setStartDelay(13 * delay);
        ...
        radiusAnimatorEnd3.setDuration(d3);
        radiusAnimatorEnd3.setStartDelay(14 * delay);
        ...
        radiusAnimatorEnd4.setDuration(d3);
        radiusAnimatorEnd4.setStartDelay(15 * delay);
        ...
        radiusAnimatorEnd5.setDuration(d3);
        radiusAnimatorEnd5.setStartDelay(16 * delay);
        ...
        bounceAnimator.setDuration(d2);
        bounceAnimator.setStartDelay(18 * delay);
    ...
    private float getRadius() {
        ...
        switch (getSize()) {
            case CrystalPreloader.Size.VERY_SMALL:
                retRadius = getTarget().getResources().getDimension(R.dimen.skype_ball_size_vs);
                break;
            case CrystalPreloader.Size.SMALL:
                retRadius = getTarget().getResources().getDimension(R.dimen.skype_ball_size_s);
                break;
            case CrystalPreloader.Size.MEDIUM:
                retRadius = getTarget().getResources().getDimension(R.dimen.skype_ball_size_m);
                break;
            case CrystalPreloader.Size.LARGE:
                retRadius = getTarget().getResources().getDimension(R.dimen.skype_ball_size_l);
                break;
            case CrystalPreloader.Size.EXTRA_LARGE:
                retRadius = getTarget().getResources().getDimension(R.dimen.skype_ball_size_el);
                break;
        }
